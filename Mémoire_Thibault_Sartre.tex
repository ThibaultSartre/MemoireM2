...
Je vais maintenant vous présenter comment sont représentés les différents types d'instructions dans les graphes de flots de contrôle.\\
Les exemples ci-dessous sont repris du site "geeksfirgeeks.org" \cite{ref18}\\
...
Avec cette définition, on peut dire que le bloc entrée domine n'importe quels blocs puisque tous chemins débute par le bloc entrée.\\
...
DCD est capable de détecter si des méthodes sont mortes peut importe si elles sont public, private ou protected.\\ Ce que nous pouvons aussi faire avec les graphes de flots de contrôle.\\
La différence étant que pour DCD il est précisé que les résultats sont des propositions et que ce n’est pas sûr à cent pourcents qu’il s'agisse bien de code mort.\\
...
DCD peut aussi détecter des initialisations inutiles de variable est bien d'autre chose qui ne nous intéresse pas directement.\\
