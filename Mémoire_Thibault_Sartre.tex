...
Avec cette définition, on peut dire que le bloc entrée domine n'importe quels blocs puisque tout chemin débute par le bloc entrée.\\
...
\subsection{Sont-ils utilisable pour faire du refactoring ?}
...
DCD peut aussi entre autres des initialisations inutiles de variables.\\
