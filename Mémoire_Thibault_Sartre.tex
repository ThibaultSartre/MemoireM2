...
Dans ce mémoire, nous allons d'abord étudier les problèmes dans les programmes qui mènent au refactoring. Ensuite on va analyser différentes techniques de refactoring. Enfin nous allons étudier les outils de refactoring existant ainsi que les graphes de flot de contrôle et s'ils sont utilisable dans le refactoring.\\
...
Et à l'avenir je pense qu'il serait intéressant de se pencher sur les graphes de flot de contrôle pour l'utiliser dans certaine partie du refactoring tel que la détection de code mort.\\
